const generateTeam = (team) => {
  ...
  const generateManager = manager => {
    ...
    <div class ="card" style="width: 18rem;">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Email: <span id="email"><a href="mailto:${manager.email}">${manager.email}</a></span></li></br>
  ...
  const generateEngineer = engineer => {
    ...
    <div class="card" style="width: 18rem;">
      ...
      <li class="list-group-item">Email: <span id="email"><a href="mailto:${engineer.email}">${engineer.email}</a></span></li></br>
  ...
  const generateIntern = intern => {
    ...
    <div class="card" style="width: 18rem;">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Email: <span id="email"><a href="mailto:${intern.email}">${intern.email}</a></span></li></br>
